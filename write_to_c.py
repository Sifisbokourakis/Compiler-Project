...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 2:
        filename = open('intFile2.int', 'r', encoding='utf-8')
...
def write_to_c(filename, outfile):
    ...
    with open(filename, 'r') as file:
        for s in file:
            ...
            words = [label.strip()] + rest.strip().split()
    ...
    with open(filename, 'r') as file:
        for s in file:
            ...
            elif words[1] in ['begin_block', 'end_block', 'halt', 'par', 'call', 'retv', 'ret']:
                pass
            else:
                print('unknown operator:', words)
                sys.exit(1)
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 2:
        ...
        print(f"More command line arguments than expected.")
        sys.exit(-1)
    else:
       print("Error: No filename provided.")
       sys.exit(-1)
